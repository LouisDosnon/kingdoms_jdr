...
const hitLocations = [
  {resultat: "1", membre: "jambe gauche"},
  {resultat: "2", membre: "jambe droite"},
  {resultat: "3-4", membre: "bras gauche"},
  {resultat: "4-5", membre: "bras droit"},
  {resultat: "6-8", membre: "torse"},
  {resultat: "9-10", membre: "tête"}
];
</script>
